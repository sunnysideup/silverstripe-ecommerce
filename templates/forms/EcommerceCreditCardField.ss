<span id="{$Name}_Holder" class="creditCardField">
	...
	<span class="enDash">-</span>
	<input name="{$Name}[3]" id="{$Form.Name}_CreditCardField4" class="ecommercecreditcard" type="text" value="{$ValueFour}" autocomplete="off" size="4" pattern="[0-9]{1,4}"  $TabIndexHTML(3) maxlength="4"onkeydown="return EcomCreditCardValidation.NumbersOnly(event)" />
</span>
