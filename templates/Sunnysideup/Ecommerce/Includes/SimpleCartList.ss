...
<li id="$CartID" class="$Classes $FirstLast orderItemHolder">
    ...
    <% end_if %>
            ...
            <% end_if %>
        <% end_loop %>
<li><a href="$EcomConfig.CheckoutLink" class="shoppingCartLink"><%t Order.GOTOCHECKOUTLINK 'Go to the checkout' %></a></li>
    <% else %>
<li><%t Order.NOITEMS 'There are <strong>no</strong> items in your cart.' %></li>
    <% end_if %>
<% end_with %>
