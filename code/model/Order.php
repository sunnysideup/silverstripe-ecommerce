...
class Order extends DataObject implements EditableEcommerceObject
{
    ...
    public static function get_needs_recalculating()
    {
        return self::$needs_recalculating;
    }
...
*******************************************************/
     ...
     */
    public function sendEmail($subject = "", $message = "", $resend = false, $adminOnly = false, $emailClassName = 'Order_InvoiceEmail')
    {
