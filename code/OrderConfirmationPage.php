...
class OrderConfirmationPage extends CartPage{
	...
	function getCMSFields(){
		...
		$fields->addFieldToTab('Root.Content.Messages.Payment', new HTMLEditorField('PaymentSuccessfulMessage', $fieldLabels["PaymentSuccessfulMessage"], 5));
		$fields->addFieldToTab('Root.Content.Messages.Payment', new HTMLEditorField('PaymentNotSuccessfulMessage', $fieldLabels["PaymentNotSuccessfulMessage"], 5));
		return $fields;
	}
