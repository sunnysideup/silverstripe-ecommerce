...
class EcommerceConfig_Definitions extends Object {
	...
	public function Definitions($className = "", $variable = "") {
		...
		################### PAGES #####################
			...
			"EcomQuantityField" => array(
				"hide_plus_and_minus" => "The Ecommerce Quantity Field (for editing product quantities in cart) has a plus and minus next to it.  These are mainly there for users who dont have javascript.  Setting this configuration to TRUE will hide the plus and minus with Javascript (so users without Javascript will still have them available). ",
			),
			"Order_Email" => array(
