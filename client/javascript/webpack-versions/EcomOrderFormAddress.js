  ...
  const EcomOrderFormAddress = {
    ...
    init: function () {
      ...
      if (this.addJSValidation) {
        ...
        window
          .jQuery(document)
          .on('submit', EcomOrderFormAddress.formSelector, function () {
    ...
    postalCodeLinkSetup: function () {
      window
        .jQuery(EcomOrderFormAddress.postalCodeLink)
        .attr('target', EcomOrderFormAddress.postalCodeLinkTarget)
    }
  }
  jQuery(() => {
