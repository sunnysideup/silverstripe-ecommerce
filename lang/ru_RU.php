...
$lang['ru_RU']['OrderReceiptEmail.ss']['HEADLINE'] = 'Квитанция заказа';
$lang['ru_RU']['Order_receiptEmail.ss']['TITLE'] = 'Квитанция магазина';
$lang['ru_RU']['OrderReceiptEmail.ss']['TITLE'] = 'Квитанция магазина';
$lang['ru_RU']['Order_statusEmail.ss']['HEADLINE'] = 'Изменение статуса заказа';
$lang['ru_RU']['OrderStatusEmail.ss']['HEADLINE'] = 'Изменение статуса заказа';
$lang['ru_RU']['Order_statusEmail.ss']['STATUSCHANGE'] = 'Статус заказа # изменен на "%s"';
$lang['ru_RU']['OrderStatusEmail.ss']['STATUSCHANGE'] = 'Статус Заказа # изменен на "%s"';
$lang['ru_RU']['Order_statusEmail.ss']['TITLE'] = 'Изменение статуса заказа';
$lang['ru_RU']['OrderStatusEmail.ss']['TITLE'] = 'Изменение статуса заказа';
